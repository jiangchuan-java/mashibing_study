package java_normal.io_nio.mmap_sendfile;
...
public class Mmap_SendFile {
    ...
    public static void mmap_01() throws Exception{
        RandomAccessFile randomAccessFile =
                new RandomAccessFile("D:\\jiangchuan\\mashibing_study\\src\\main\\java\\java_normal.io_nio\\mmap_sendfile\\config.txt","rw");
